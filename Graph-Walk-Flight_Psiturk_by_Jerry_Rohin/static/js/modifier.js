...
instruct_short_4="<div style='margin-left:200px ;margin-right: 200px ;text-justify: auto'><p style ='font-size: 50px;line-height:1.5'>This client will be leaving from the top city (New York City), and wishes to know which out of the two bottom destinations (St. Louis or Detroit) requires fewer layovers.</p><img src= '../static/images/shortestarrow.png' width='1200' height='600'<br /><p style= 'font-size:25px;margin-top:100px'>[press the spacebar to continue]</p>"
