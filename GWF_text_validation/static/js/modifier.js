...
instruct_dir_3 = "<div style='margin-left:200px ;margin-right: 200px ;text-justify: auto'><p style ='font-size: 50px;line-height:1.5'>You will be asked how confident you are in determining whether the city name is <b>OLD</b> (what you have seen before) or <b>NEW</b>.<br><br>If you think the city name is definitely old, press '1'<br>If you are unsure but think it is old, press '2'<br>If you are unsure but think it is new, press '3'<br>If it is definitely new, press '4'<br></p><p style= 'font-size:25px;margin-top:100px'>[press the spacebar to continue]</p>",
